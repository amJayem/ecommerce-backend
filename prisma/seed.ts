...
function generateProductId(sequence: number): number {
  ...
  // Generate ID: datePrefix + sequence
  // Example: "20251029" + "1" = "202510291"
  return parseInt(`${datePrefix}${sequence}`, 10);
}
